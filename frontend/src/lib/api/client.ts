...
import { authEndpoints, catalogEndpoints, exercisesEndpoints, submissionsEndpoints } from './generated'
...
export const catalogApi = new Zodios(API_BASE_URL, catalogEndpoints) as any
